...
import no.dossier.libraries.amqpconnector.platform.Delivery
...
class AmqpConsumer<T : Any, U : Any>(
    ...
    // TODO replace this with immutable implementation
    private class AmqpConsumerState(
        var connection: Connection? = null,
        var consumerThreadPoolDispatcher: CoroutineDispatcher? = null,
        var tag: String? = null,
    ...
    fun startConsuming(connection: Connection): String {

        state.connection = connection
        state.consumerThreadPoolDispatcher = connection.consumerThreadPoolDispatcher
        ...
        state.tag = amqpChannel.basicConsume(actualMainQueueName, autoAckEnabled,
            getDeliverCallback(connection.consumerThreadPoolDispatcher!!, amqpChannel)
        ) { _ -> }
    ...
    private fun getDeliverCallback(
        consumerThreadPoolDispatcher: CoroutineDispatcher,
        amqpChannel: Channel
